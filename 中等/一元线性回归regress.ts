...
// 代价函数
function J(a: number, b: number, xi: number[], yi: number[]): number {
...
// 对 J 求 a 的偏导
function Ja(a: number, b: number, xi: number[], yi: number[]): number {
  const number = xi.length
  let sum = 0
  for (let i = 0; i < number; i++) {
...
// 对 J 求 b 的偏导
function Jb(a: number, b: number, xi: number[], yi: number[]): number {
  const number = xi.length
  let sum = 0
  for (let i = 0; i < number; i++) {
